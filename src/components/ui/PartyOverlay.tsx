  ...
  return (
    <>
      ...
      <button
        ...
        className={`group fixed bottom-[136px] right-6 z-50 hidden md:flex items-center justify-center p-3 rounded-full border transition-all backdrop-blur-sm shadow-lg overflow-hidden ${isSpotifyPlaying
