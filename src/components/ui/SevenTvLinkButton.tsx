...
export function SevenTvLinkButton() {
  return (
    <a
      ...
      className="group fixed top-6 right-6 z-50 hidden md:flex items-center justify-center p-2 rounded-full bg-black/40 hover:bg-black/60 border border-white/10 text-white/70 hover:text-white transition-all backdrop-blur-sm shadow-lg overflow-hidden"
    >
