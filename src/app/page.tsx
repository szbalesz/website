  ...
  return (
    <main className="flex min-h-[100dvh] flex-col items-center justify-center text-text-primary antialiased relative">
      ...
      <div className="mx-auto w-full max-w-2xl px-4 z-10 relative">
        <div className="rounded-xl shadow-[0_0_20px_2px_#13141666,0_0_60px_10px_#13141633] animate-card" style={{ animationDelay: '2.2s' }}>
          <div className="relative rounded-xl">
            ...
            {/* CARD BODY */}
            <div className="relative bg-bg-card px-6 pb-6 pt-16 rounded-b-xl border border-border">
              ...
              <div className="absolute right-6 top-4 flex items-center gap-1">
                <span className="group relative inline-flex">
                  ...
                  <span className="pointer-events-none absolute bottom-full left-1/2 z-[9999] mb-1.5 -translate-x-1/2 w-max rounded-md bg-bg-primary px-3 py-1.5 text-center opacity-0 shadow-lg transition-opacity group-hover:opacity-100">
                    ...
                    <span className="mt-0.5 block w-max max-w-[250px] text-[11px] leading-tight text-text-muted">2005. 08. 20.</span>
              ...
              <div className="absolute -top-12 left-1/2 -translate-x-1/2">
                <div className="relative flex-shrink-0" style={{ width: '96px', height: '96px' }}>
                  <img src="https://cdn.discordapp.com/avatars/305732881144086528/a_a0b61953e1eaff386c8e1bd2a41285d3.gif?size=512" alt="SzBalesz" width="96" height="96" style={{ width: '96px', height: '96px', borderRadius: '50%', objectFit: 'cover', display: 'block' }} />
              ...
              <div className="mb-4 text-center mt-2">
                <div className="flex items-center justify-center gap-2">
                  <span className="text-2xl font-bold text-text-primary font-designer tracking-wider">SZBALESZ</span>
                </div>
              </div>
              ...
              {/* CONNECTIONS */}
              <div className="animate-expand-wrapper" style={{ animationDelay: '2.2s' }}>
                <div className="animate-expand-inner">
                  <div className="text-center justify-center">
                    <div className="grid grid-cols-1 gap-2 sm:grid-cols-2">
                      ...
                      {/* Discord */}
                      <a href="https://discordapp.com/users/305732881144086528" target="_blank" rel="noopener noreferrer" className="block rounded-lg border transition-opacity hover:opacity-80 animate-card" style={{ borderColor: '#5865F230', animationDelay: '2.9s' }}>
                        <div className="flex items-center gap-2 rounded-lg px-3 py-2 text-sm transition-colors" style={{ backgroundColor: '#5865F215', borderColor: '#5865F230' }}>
                          ...
                          <div className="min-w-0">
                            ...
                            <span className="ml-1.5 text-xs text-text-muted">Discord</span>
                          </div>
                      ...
                      {/* Twitch */}
                      <a href="https://twitch.tv/szbalesz" target="_blank" rel="noopener noreferrer" className="block rounded-lg border transition-opacity hover:opacity-80 animate-card" style={{ borderColor: '#9146FF30', animationDelay: '3.0s' }}>
                        <div className="flex items-center gap-2 rounded-lg px-3 py-2 text-sm transition-colors" style={{ backgroundColor: '#9146FF15', borderColor: '#9146FF30' }}>
                      ...
                      {/* Instagram */}
                      <a href="https://instagram.com/szbalesz" target="_blank" rel="noopener noreferrer" className="block rounded-lg border transition-opacity hover:opacity-80 animate-card" style={{ borderColor: '#E4405F30', animationDelay: '3.1s' }}>
                        <div className="flex items-center gap-2 rounded-lg px-3 py-2 text-sm transition-colors" style={{ backgroundColor: '#E4405F15', borderColor: '#E4405F30' }}>
                          ...
                          <div className="min-w-0">
                            <span className="font-medium text-text-primary">szbalesz</span>
                            <span className="ml-1.5 text-xs text-text-muted">Instagram</span>
                          </div>
                      ...
                      {/* YouTube */}
                      <a href="https://youtube.com/@szbalesz" target="_blank" rel="noopener noreferrer" className="block rounded-lg border transition-opacity hover:opacity-80 animate-card" style={{ borderColor: '#FF000030', animationDelay: '3.2s' }}>
                        <div className="flex items-center gap-2 rounded-lg px-3 py-2 text-sm transition-colors" style={{ backgroundColor: '#FF000015', borderColor: '#FF000030' }}>
                          ...
                          <div className="min-w-0">
                            <span className="font-medium text-text-primary">szbalesz</span>
                            <span className="ml-1.5 text-xs text-text-muted">YouTube</span>
                          </div>
                      ...
                      {/* Kick */}
                      <a href="https://kick.com/szbalesz" target="_blank" rel="noopener noreferrer" className="block rounded-lg border transition-opacity hover:opacity-80 animate-card" style={{ borderColor: '#53fc1830', animationDelay: '3.3s' }}>
                        <div className="flex items-center gap-2 rounded-lg px-3 py-2 text-sm transition-colors" style={{ backgroundColor: '#53fc1815', borderColor: '#53fc1830' }}>
                          <img src="/logos/kick.webp" alt="Kick" width="18" height="18" className="flex-shrink-0" style={{ objectFit: 'contain' }} />
                          <div className="min-w-0">
                            <span className="font-medium" style={{ opacity: 1, backgroundImage: 'linear-gradient(0deg, rgb(255, 200, 82) 0%, rgb(254, 239, 144) 15%, rgb(254, 213, 124) 30%, rgb(255, 255, 255) 60%)', backgroundSize: '100% 100%', backgroundRepeat: 'unset', filter: 'drop-shadow(rgb(255, 162, 0) 0px 0px 4px)', WebkitBackgroundClip: 'text', color: 'transparent' }}>SZBALESZ</span>
                            <span className="ml-1.5 text-xs text-text-muted">Kick</span>
                          </div>
                      ...
                      {/* Spotify */}
                      <a href="https://open.spotify.com/user/SzBalesz" target="_blank" rel="noopener noreferrer" className="block rounded-lg border transition-opacity hover:opacity-80 animate-card" style={{ borderColor: '#1DB95430', animationDelay: '3.4s' }}>
                        <div className="flex items-center gap-2 rounded-lg px-3 py-2 text-sm transition-colors" style={{ backgroundColor: '#1DB95415', borderColor: '#1DB95430' }}>
                          ...
                          <div className="min-w-0">
                            <span className="font-medium text-text-primary">SzBalesz</span>
                            <span className="ml-1.5 text-xs text-text-muted">Spotify</span>
                          </div>
                      ...
                      {/* GitHub */}
                      <a href="https://github.com/szbalesz" target="_blank" rel="noopener noreferrer" className="block rounded-lg border transition-opacity hover:opacity-80 animate-card" style={{ borderColor: '#FFFFFF30', animationDelay: '3.5s' }}>
                        <div className="flex items-center gap-2 rounded-lg px-3 py-2 text-sm transition-colors" style={{ backgroundColor: '#FFFFFF15', borderColor: '#FFFFFF30' }}>
                          ...
                          <div className="min-w-0">
                            <span className="font-medium text-text-primary">szbalesz</span>
                            <span className="ml-1.5 text-xs text-text-muted">GitHub</span>
                          </div>
                      ...
                      {/* TikTok */}
                      <a href="https://tiktok.com/@notszbalesz" target="_blank" rel="noopener noreferrer" className="block rounded-lg border transition-opacity hover:opacity-80 animate-card" style={{ borderColor: '#ffffff30', animationDelay: '3.6s' }}>
                        <div className="flex items-center gap-2 rounded-lg px-3 py-2 text-sm transition-colors" style={{ backgroundColor: '#ffffff15', borderColor: '#ffffff30' }}>
                          ...
                          <div className="min-w-0">
                            ...
                            <span className="ml-1.5 text-xs text-text-muted">TikTok</span>
                          </div>
                          <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#ffffff" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" className="ml-auto flex-shrink-0"><polyline points="20 6 9 17 4 12"></polyline></svg>
                        </div>
                      </a>
