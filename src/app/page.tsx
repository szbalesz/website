        ...
        <SavedEmotesProvider>
          <main className="flex min-h-[100dvh] flex-col items-center justify-center text-text-primary antialiased relative">
            ...
            <CardVisibilityWrapper>
              <div className="mx-auto w-full max-w-2xl px-4 z-10 relative pointer-events-none">
                <Card className="pointer-events-auto !bg-black/40 backdrop-blur-md !ring-white/10 rounded-xl shadow-[0_0_30px_5px_rgba(0,0,0,0.5)] animate-card transition-transform duration-300 ease-out p-0">
                    ...
                    <div className="relative rounded-xl overflow-hidden w-full">
                      ...
                      <div className="relative px-6 pb-6 pt-16 rounded-b-xl border-t-0 border-x border-b border-white/5 bg-gradient-to-b from-black/60 to-transparent">
                        ...
                        <div className="flex sm:hidden justify-center mt-6">
                          <div className="flex items-center justify-center px-2.5 py-1 rounded-full bg-black/40 border border-white/10 text-white/50 backdrop-blur-sm shadow-lg text-[9px] font-medium cursor-default animate-button-in">
            ...
            <ControlsMenu />
            <div className="absolute bottom-6 left-1/2 -translate-x-1/2 z-20 hidden sm:flex items-center justify-center px-2.5 py-1 rounded-full bg-black/40 border border-white/10 text-white/50 backdrop-blur-sm shadow-lg text-[9px] font-medium cursor-default animate-button-in">
              © {new Date().getFullYear()} SZBALESZ Minden jog fenntartva.
            </div>
          </main>
        </SavedEmotesProvider>
