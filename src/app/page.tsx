        ...
        <Card className="rounded-xl shadow-[0_0_20px_2px_#13141666,0_0_60px_10px_#13141633] animate-card transition-transform duration-300 ease-out hover:scale-105 p-0" style={{ animationDelay: '2.2s' }}>
          <div className="relative rounded-xl overflow-hidden">
            ...
            <div className="relative bg-bg-card px-6 pb-6 pt-16 rounded-b-xl border border-border">
              ...
              {/* CONNECTIONS */}
              <div className="animate-expand-wrapper" style={{ animationDelay: '2.1s' }}>
                <div className="animate-expand-inner">
                  <div className="text-center justify-center">
                    <div className="grid grid-cols-1 gap-2 sm:grid-cols-2">
                      ...
                      {/* Discord */}
                      <Button asChild variant="outline" className="h-auto p-0 border-none bg-transparent hover:bg-transparent hover:opacity-80 animate-card" style={{ animationDelay: '3.1s' }}>
                        <a href="https://discordapp.com/users/305732881144086528" target="_blank" rel="noopener noreferrer" className="block w-full">
                      ...
                      {/* Twitch */}
                      <Button asChild variant="outline" className="h-auto p-0 border-none bg-transparent hover:bg-transparent hover:opacity-80 animate-card" style={{ animationDelay: '3.2s' }}>
                        <a href="https://twitch.tv/szbalesz" target="_blank" rel="noopener noreferrer" className="block w-full">
                      ...
                      {/* Instagram */}
                      <Button asChild variant="outline" className="h-auto p-0 border-none bg-transparent hover:bg-transparent hover:opacity-80 animate-card" style={{ animationDelay: '3.3s' }}>
                        <a href="https://instagram.com/szbalesz" target="_blank" rel="noopener noreferrer" className="block w-full">
                      ...
                      {/* YouTube */}
                      <Button asChild variant="outline" className="h-auto p-0 border-none bg-transparent hover:bg-transparent hover:opacity-80 animate-card" style={{ animationDelay: '3.4s' }}>
                        <a href="https://youtube.com/@szbalesz" target="_blank" rel="noopener noreferrer" className="block w-full">
                      ...
                      {/* Kick */}
                      <Button asChild variant="outline" className="h-auto p-0 border-none bg-transparent hover:bg-transparent hover:opacity-80 animate-card" style={{ animationDelay: '3.5s' }}>
                        <a href="https://kick.com/szbalesz" target="_blank" rel="noopener noreferrer" className="block w-full">
                      ...
                      {/* Spotify */}
                      <Button asChild variant="outline" className="h-auto p-0 border-none bg-transparent hover:bg-transparent hover:opacity-80 animate-card" style={{ animationDelay: '3.6s' }}>
                        <a href="https://open.spotify.com/user/SzBalesz" target="_blank" rel="noopener noreferrer" className="block w-full">
                      ...
                      {/* GitHub */}
                      <Button asChild variant="outline" className="h-auto p-0 border-none bg-transparent hover:bg-transparent hover:opacity-80 animate-card" style={{ animationDelay: '3.7s' }}>
                        <a href="https://github.com/szbalesz" target="_blank" rel="noopener noreferrer" className="block w-full">
                      ...
                      {/* TikTok */}
                      <Button asChild variant="outline" className="h-auto p-0 border-none bg-transparent hover:bg-transparent hover:opacity-80 animate-card" style={{ animationDelay: '3.8s' }}>
                        <a href="https://tiktok.com/@notszbalesz" target="_blank" rel="noopener noreferrer" className="block w-full">
                          <div className="flex items-center gap-2 rounded-lg px-3 py-2 text-sm transition-colors border" style={{ backgroundColor: '#ffffff15', borderColor: '#ffffff30' }}>
