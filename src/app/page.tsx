          ...
          <main className="flex min-h-[100dvh] flex-col items-center justify-center text-text-primary antialiased relative">
            ...
            <CardVisibilityWrapper>
              <div className="mx-auto w-full max-w-2xl px-4 z-10 relative pointer-events-none">
                <Card className="pointer-events-auto !bg-black/40 backdrop-blur-md !ring-white/10 rounded-xl shadow-[0_0_30px_5px_rgba(0,0,0,0.5)] animate-card transition-transform duration-300 ease-out p-0" style={{ animationDelay: '2.2s' }}>
                  <div className="animate-card-inner w-full">
                    <div className="relative rounded-xl overflow-hidden w-full">
                      ...
                      <div
                        ...
                        style={{
                          backgroundImage: `url('${process.env.NEXT_PUBLIC_DISCORD_BANNER_URL || `https://cdn.discordapp.com/banners/${process.env.NEXT_PUBLIC_DISCORD_USER_ID}/a_df5e94147df1f27e6aaf29a72e1f710d.gif?size=4096`}')`,
